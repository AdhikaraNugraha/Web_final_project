  	...
  	<div class="col-md-12">
  		<div class="box box-info">
  	            <div class="box-header with-border">
  	              <h3 class="box-title">Isi Form Pendaftaran</h3>
  	            </div>
  	            <!-- /.box-header -->
  	            <!-- form start -->
                  ...
                  {!! csrf_field() !!}
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="Judul Skripsi" name="alamat" placeholder="Judul Skripsi">
                      </div>
                    </div>
      ...
      <div class="box box-info">
                ...
                <form class="form-horizontal" action="{{ asset('mhs/proseseditmahasiswa') }}" method="post">
                  ...
                  <div class="box-body">
                    ...
                    <div class="form-group">
                      <label for="alamat" class="col-sm-2 control-label">Judul Skripsi</label>
                      <div class="col-sm-8">
  ...
  @if($act=="viewMahasiswa" || $act=="ViewDeleteMahasiswa")
    ...
    @endif
  	...
  	<div class="col-md-12">
  		<div class="box box-info">
  	            <div class="box-header with-border">
  	              <h3 class="box-title">Data Ujian Mahasiswa</h3>
